...
<body>
    ...
    <p>A side bar should be here</p>
    <p>The following are the users in our DB;</p>
    @foreach ($users as $user)
        <p> <li>This is the user's name . {{ $user->name}} . and this is the corresponding email . {{$user->email}}. </li></p>
    @endforeach
</body>
</html> --}}

{{-- Assignment
1. Create a Product Model and migration table with the following details;
    name, description, price, quantity, status.
2. Create a UI for 5 products, showing:name,price,button(more), in the userdashboard.blade.php file and create a route to display the view on the product.
3. On the side bar for the admin dashboard create a button called "registered users" for a table that will display the all the registered users on the site.
4. Create a ProductController and write a function to create a product.
N/B; push it to git and share with the link on whatsapp
    --}}
          ...
          <div class="container-fluid page-body-wrapper">
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-toggle="collapse" href="{{route("users.all")}}" aria-expanded="false" aria-controls="ui-basic">
